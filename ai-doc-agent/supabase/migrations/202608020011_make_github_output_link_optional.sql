-- Replaces the output-assembly guard for environments that already applied
-- 202608020010. GitHub must start the agent graph, but does not need to map
-- directly to an output-file target.
